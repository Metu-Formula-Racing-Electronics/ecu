#ifndef bamocar_register_h
#define bamocar_register_h

#define STD_RXID 0x201 //default ID adress for receiving messages
#define STD_TXID 0x181 //default ID adress for sending messages
#define STD_BAUDRATE 100000 

#define REG_ENABLE 0x51    //Register for automatic transmission
...
Directly taken from github, will be modified accrodingly
*/

//predefined intervals for cyclic requests
